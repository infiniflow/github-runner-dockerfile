...
# curl -O -L https://github.com/actions/runner/releases/download/v2.322.0/actions-runner-linux-x64-2.325.0.tar.gz \
RUN --mount=type=bind,source=actions-runner-linux-x64-2.325.0.tar.gz,target=/actions-runner.tar.gz \
    cd /home/alice \
